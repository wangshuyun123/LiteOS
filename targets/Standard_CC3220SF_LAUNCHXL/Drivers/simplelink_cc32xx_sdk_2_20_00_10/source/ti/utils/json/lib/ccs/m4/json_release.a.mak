...
package/lib/lib/ccs/m4/json_release/package/package_ti.utils.json.oem4: package/package_ti.utils.json.c lib/ccs/m4/json_release.a.mak
	...
	$(RM) $@
	@$(MSG) clem4 $< ...
	$(ti.targets.arm.elf.M4.rootDir)/bin/armcl -c  -qq -pdsw225 --endian=little -mv7M4 --float_support=vfplib --abi=eabi -eo.oem4 -ea.sem4  -ms -g --c99  -DALLOW_PARSING__TEMPLATE -DALLOW_PARSING__JSON -D USE__STANDARD_LIBS  -I/vagrant/SDK_Q2_GA_Gen2_Only/sdk_root/source/ti/posix/ccs -Dxdc_target_name__=M4 -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_18_1_2 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.M4.rootDir)/include  -fs=./package/lib/lib/ccs/m4/json_release/package -fr=./package/lib/lib/ccs/m4/json_release/package -fc $<
	$(MKDEP) -a $@.dep -p package/lib/lib/ccs/m4/json_release/package -s oem4 $< -C   -qq -pdsw225 --endian=little -mv7M4 --float_support=vfplib --abi=eabi -eo.oem4 -ea.sem4  -ms -g --c99  -DALLOW_PARSING__TEMPLATE -DALLOW_PARSING__JSON -D USE__STANDARD_LIBS  -I/vagrant/SDK_Q2_GA_Gen2_Only/sdk_root/source/ti/posix/ccs -Dxdc_target_name__=M4 -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_18_1_2 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.M4.rootDir)/include  -fs=./package/lib/lib/ccs/m4/json_release/package -fr=./package/lib/lib/ccs/m4/json_release/package
	-@$(FIXDEP) $@.dep $@.dep
...
package/lib/lib/ccs/m4/json_release/source/json.oem4: source/json.c lib/ccs/m4/json_release.a.mak
	...
	$(RM) $@
	@$(MSG) clem4 $< ...
	$(ti.targets.arm.elf.M4.rootDir)/bin/armcl -c  -qq -pdsw225 --endian=little -mv7M4 --float_support=vfplib --abi=eabi -eo.oem4 -ea.sem4  -ms -g --c99  -DALLOW_PARSING__TEMPLATE -DALLOW_PARSING__JSON -D USE__STANDARD_LIBS  -I/vagrant/SDK_Q2_GA_Gen2_Only/sdk_root/source/ti/posix/ccs -Dxdc_target_name__=M4 -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_18_1_2 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.M4.rootDir)/include  -fs=./package/lib/lib/ccs/m4/json_release/source -fr=./package/lib/lib/ccs/m4/json_release/source -fc $<
	$(MKDEP) -a $@.dep -p package/lib/lib/ccs/m4/json_release/source -s oem4 $< -C   -qq -pdsw225 --endian=little -mv7M4 --float_support=vfplib --abi=eabi -eo.oem4 -ea.sem4  -ms -g --c99  -DALLOW_PARSING__TEMPLATE -DALLOW_PARSING__JSON -D USE__STANDARD_LIBS  -I/vagrant/SDK_Q2_GA_Gen2_Only/sdk_root/source/ti/posix/ccs -Dxdc_target_name__=M4 -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_18_1_2 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.M4.rootDir)/include  -fs=./package/lib/lib/ccs/m4/json_release/source -fr=./package/lib/lib/ccs/m4/json_release/source
	-@$(FIXDEP) $@.dep $@.dep
