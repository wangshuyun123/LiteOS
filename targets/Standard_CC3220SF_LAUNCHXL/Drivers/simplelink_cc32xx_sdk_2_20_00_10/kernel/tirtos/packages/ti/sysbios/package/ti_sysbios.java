...
public class ti_sysbios
{
    ...
    void BIOS$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.BIOS.version", 0x65501L);
    ...
    void BIOS$$TYPES()
    {
        ...
        po.init("ti.sysbios.BIOS.Module", om.findStrict("xdc.runtime.IModule.Module", "ti.sysbios"));
                ...
                po.addFld("version", Proto.Elm.newCNum("(xdc_UInt32)"), 0x65501L, "rh");
        if (isCFG) {
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.aem4',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.am4g',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.arm4',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.aem4', {target: 'ti.targets.arm.elf.M4', suffix: 'em4'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.am4g', {target: 'gnu.targets.arm.M4', suffix: 'm4g'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.arm4', {target: 'iar.targets.arm.M4', suffix: 'rm4'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
